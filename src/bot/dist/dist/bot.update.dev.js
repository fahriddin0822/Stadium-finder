...
function () {
  ...
  __decorate([nestjs_telegraf_1.Start(), __param(0, nestjs_telegraf_1.Ctx())], BotUpdate.prototype, "onStart");

  __decorate([nestjs_telegraf_1.On("contact"), __param(0, nestjs_telegraf_1.Ctx())], BotUpdate.prototype, "onContact");

  BotUpdate = __decorate([nestjs_telegraf_1.Update()], BotUpdate);
  return BotUpdate;
}();
